...
Cope better with Win32 directory separators, fix some thumbnail issues.
...
* Ensure post thumbnails are enabled (in case the theme doesn't support them).
* Move image size setting into after_setup_theme.
