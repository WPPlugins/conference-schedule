...
class ConfSched extends ConfSched_Plugin {
	...
	/**
	 * Hooks the WP action after_setup_theme to:
	 * * Add post thumbnail support (in case the current theme doesn't)
	...
	public function admin_notices() {
		...
		if ( ! $this->get_option( 'days' ) &&
		  	( $screen->id == 'settings_page_conf_sched' || (isset( $screen->post_type ) && $screen->post_type == 'session' ) ) ) {
			echo '<div id="message" class="updated"><p>';
